...
export class LayerStack {
    ...
    addNoiseLayer(params: Partial<NoiseLayer> = {}): NoiseLayer {
    ...
    addCircleLayer(params: Partial<CircleLayer> = {}): CircleLayer {
    ...
    addImageLayer(params: Partial<ImageLayer> = {}): ImageLayer {
